...
export default function Footer() {
  return (
    <footer className="w-full bg-fein-light px-6 pb-10 pt-16 text-center md:px-16">
      <span className="mx-auto mb-8 block h-px w-16 bg-accent/40" aria-hidden="true" />
      <p className="text-sm text-neutral-600 dark:text-neutral-500">Fein — Estudio de diseño e identidad de marca.</p>
